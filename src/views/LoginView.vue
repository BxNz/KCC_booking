  ...
  <div
    ...
    <div
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div>
          <div class="flex justify-between items-center mb-1.5">
            ...
            <a href="#" class="text-[11px] text-blue-600 hover:text-blue-800 transition font-medium">Choose user</a>
          </div>
          <div class="relative">
      ...
      <div class="mt-6 text-center">
        <a href="#" class="text-[11px] text-slate-400 hover:text-slate-600 transition font-medium">
